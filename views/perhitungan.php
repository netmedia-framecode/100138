          ...
          <div class="table-responsive">
            <table class="table table-bordered text-dark" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <?php
                  $total_value = $conn->real_escape_string($total[$key]);
                  $rank_value = $conn->real_escape_string($rank[$key]);
                  $id_alternatif = $conn->real_escape_string($key);
                  $sql = "UPDATE alternatif SET total='$total_value', `rank`='$rank_value' WHERE id_alternatif='$id_alternatif'";
